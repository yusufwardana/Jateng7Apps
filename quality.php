                            ...
                            <a href="<?php echo $ur['blog_dir'];?>?inp=quality" class="list-group-item list-group-item-action border-color">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center pl-0">
                                        <h6 class="mb-1">Report Daily Quality</h6>
                                        <p class="text-secondary">Input Daily Quality</p>
                                    </div>
                                </div>
                            </a>
                            <a href="" class="list-group-item list-group-item-action border-color">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center pl-0">
                                        ...
                                        <p class="text-secondary">Day to Day Schedule</p>
                                    </div>
                                </div>
                            </a>
                            <a href="/?page=nmrank" class="list-group-item list-group-item-action border-color">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 bg-default-light text-default rounded">
