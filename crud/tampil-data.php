        ...
        <div class="panel-body">
          <table class="table table-striped table-hover" id="dataTables-example">
            ...
            try {
              ...
              $query = "SELECT * FROM optima ORDER BY ID DESC";
              ...
              while ($data = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<tr>
                        ...
                        <?php
                          ...
                          <td><img class='img-mahasiswa' src='foto/<?php echo $data['NAMA']; ?>' width='45'></td>
                        <?php
                        }

                echo "  <td width='60'>$data[NIK]</td>
                        <td width='150'>$data[NAMA]</td>
                        <td width='180'>$data[TEMPATLAHIR], $tanggal_lahir</td>
                        <td width='120'>$data[STATUS]</td>
                        <td width='100'>$data[AGAMA]</td>
                        <td width='250'>$data[ALAMAT1]</td>
                ...
                ?>
                            <a href="#" onclick="confirm_modal('proses-hapus.php?&nim=<?php echo $data['ID']; ?>');" data-nim="<?php echo $data['ID']; ?>" data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm">
